...
; Baseado no exemplo inicial do simulador (print "Hello World!"),  imprima apenas os caracteres ‘o’, caso contrário, imprima ‘  ‘ (um espaço em branco). 
...
.space:                   ; não é letra 'o' ou 'O' -> imprime ' '7
    MOV A, 32		  ; 32 -> código decimal do espaço
    MOV [D], A         
    INC C
    INC D
    JMP .loop
